...
puzzle = """MMMMASXMMMMXXMASMMXSAMMMSAMXSXMMXMXMXAMAMXSXXXMXAXAMXMMXAASAMXMSMMMSXSAMXMASAXXAMXAMXAXSXXMASXMMXMASXMAXXMASMMMMXMXSMSSSXSASASMSAMXXSMSMSSXS
...
def s_as_list_of_lists(s: str) -> List[List[str]]:
    return [list(r.strip()) for r in s.splitlines()]
